...
class HomePage_Section(models.Model):
	...
	billboard_image = FileBrowseField(max_length=200, blank=True, null=True, directory='home_billboards', help_text='1050px wide x 380px tall')
	graph_image = FileBrowseField(max_length=200, blank=True, null=True, help_text='1050px wide, 700px tall', directory='home_page_graphs')
